...
public class DataproviderAndExtentReport {
WebDriver driver;
...
public void test(String username, String password, String expectedErrorMessage) throws InterruptedException {
	ExtentReports report = new ExtentReports("ExtentReportResults.html");
...
loginButton.click();
test.log(LogStatus.FAIL, expectedErrorMessage);
String actualErrorMessage = driver.findElement(By.id("body_lblStatus")).getText();
org.testng.Assert.assertEquals(expectedErrorMessage, actualErrorMessage);
